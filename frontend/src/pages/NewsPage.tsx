      ...
      try {
        ...
        const mockNews: NewsItem[] = [
          ...
          },
          {
            ...
            details: 'A equipe brasileira da FURIA Esports conseguiu uma importante vitória contra a favorita Natus Vincere (NAVI) nas quartas de final do Major. Após perder o primeiro mapa (Nuke) por 16-9, a FURIA reagiu vencendo Inferno por 16-14 e Mirage por 16-12. O destaque da partida foi Kaike "KSCERATO" Cerato, que terminou a série com 74 abates e rating de 1.37. "Estamos jogando nosso melhor CS e provando que podemos competir contra qualquer equipe do mundo", declarou o capitão Andrei "arT" Piovezan após a vitória. A foto captura o momento de celebração da equipe após o resultado histórico, com os jogadores se abraçando diante da bandeira brasileira exibida ao fundo. Na imagem, é possível ver KSCERATO, chelo e os outros integrantes da equipe celebrando a classificação. A FURIA enfrentará a Team Vitality na semifinal, marcada para este sábado.',
            source: {
              name: 'EGamersWorld',
