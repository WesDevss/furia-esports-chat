...
const Footer: React.FC = () => {
  return (
    <footer className="bg-furia-black border-t border-furia-darker py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              ...
              conectando fãs e jogadores durante as partidas.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/chat" className="text-gray-400 hover:text-furia-purple transition-colors">Chat ao Vivo</Link>
              </li>
              <li>
                <Link to="/calendar" className="text-gray-400 hover:text-furia-purple transition-colors">Calendário</Link>
              </li>
              <li>
                <Link to="/results" className="text-gray-400 hover:text-furia-purple transition-colors">Resultados</Link>
              </li>
              <li>
                <Link to="/players" className="text-gray-400 hover:text-furia-purple transition-colors">Jogadores</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#" className="text-gray-400 hover:text-furia-purple transition-colors">Termos de Uso</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-furia-purple transition-colors">Política de Privacidade</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-furia-purple transition-colors">Cookies</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* Copyright */}
        <div className="mt-8 pt-6 border-t border-furia-darker text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} FURIA Esports. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
